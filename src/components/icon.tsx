...
/** @desc Instagram icon */
export const Facebook = ({className,...rest}:IconPropsType) => (
  <svg
...
/** @desc Facebook icon */
export const Instagram = ({className,...rest}:IconPropsType) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
...
export const GithubIcon = ({ className, ...rest }:IconPropsType) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
...
export const TwitterIcon = ({ className, ...rest }:IconPropsType) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
...
// #0A66C2
export const LinkedInIcon = ({ className, ...rest }:IconPropsType) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
...
export const CircularText = ({ className, ...rest }:IconPropsType) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="496"
    height="496"
...
export const LinkArrow = ({ className, ...rest }:IconPropsType) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={24}
    height={24}
